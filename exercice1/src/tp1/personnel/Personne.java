...
public class Personne{
	...
	{
		Personne.nbrInstance +=1;
	}
	public static int getNbrInstance() {
		return nbrInstance;
	}
	public static boolean plusAgee(Personne p,Personne p2) {
		 boolean b =!p.dateNaissance.after(p2.dateNaissance);
		return b;
	}
	public boolean plusAgeeQue(Personne hPersonne2) {
		boolean a = !(this.dateNaissance.after(hPersonne2.dateNaissance));
		return a;
	}
	
	@Override
	public boolean equals(Object obj) {
		return obj instanceof Personne && (this.nom.equals(((Personne)obj).getNom())) && (this.prenom.equals(((Personne)obj).getPrenom())) 
